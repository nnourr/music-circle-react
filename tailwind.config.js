  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        "linear-gradient": "linear-gradient(215deg, #29EB26 0%, #29C39F 51.5%, #3FB1AB 100%)",
        "linear-gradient-breathe-1": "linear-gradient(215deg #29EB26 0% #29C39F 30% #3FB1AB 100%)",
        "linear-gradient-breathe-2": "linear-gradient(215deg #29EB26 0% #29C39F 70% #3FB1AB 100%)",
      }
    },
  },
  plugins: [],
